...
class ClaimReleasePackage:
    ...
    def __post_init__(self) -> None:
        ...
        # Package-level limitation/non-endorsement claims are release gates, not construction
        # gates. Keeping the invalid posture representable lets validators and readiness
        # reports explain why a package cannot be released.
